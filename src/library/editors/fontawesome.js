...
export class FontAwesomeEditor extends Jedison.EditorString {
  ...
  build () {
    ...
    this.control = this.theme.getInputControl({
      ...
      titleIconClass: Jedison.Schema.getSchemaXOption(this.instance.schema, 'titleIconClass'),
      titleHidden: Jedison.Schema.getSchemaXOption(this.instance.schema, 'titleHidden'),
      info: this.getInfo()
    });
