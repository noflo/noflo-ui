describe('Registry Middleware', function() {
  let mw = null;
  ...
  describe('receiving a flowhub:runtimes:fetch action', function() {
    let mock = null;
    beforeEach(() => mock = sinon.fakeServer.create());
    afterEach(() => mock.restore());
    it('should send storage:save:runtime for each runtime on server', function(done) {
      ...
      mw.receiveAction('storage:save:runtime', check, function(err) {
