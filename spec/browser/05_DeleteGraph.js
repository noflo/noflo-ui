describe('Deleting a graph', () => {
  ...
  describe('initially', () => it('should have a graph editor available', () => {
  ...
  describe('graph settings', () => it('should show the graph settings modal when clicked', function (done) {
    this.timeout(7000);
  ...
  describe('graph delete', () => it('should remove the graph and project and redirect home', function (done) {
    this.timeout(7000);
