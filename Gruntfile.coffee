module.exports = ->
  ...
  @registerTask 'main_rebuild', ['exec:nuke_main', 'exec:nuke_bower', 'exec:main_install', 'exec:bower_install', 'exec:main_build']
  @registerTask 'preview_rebuild', ['exec:nuke_preview', 'exec:preview_install', 'exec:preview_build']
